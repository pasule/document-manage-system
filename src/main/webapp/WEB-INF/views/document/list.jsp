...
<head>
    ...
    <style>
        ...
        .action-btn { background: #1976d2; color: #fff; border: none; border-radius: 4px; padding: 6px 16px; margin: 0 4px; cursor: pointer; transition: background 0.2s; text-decoration: none; }
        .action-btn:hover { background: #1565c0; }
    </style>
</head>
<body>
<h2 style="text-align:center; color:#1976d2; margin-top:30px;">全部档案</h2>
    ...
    <c:forEach var="doc" items="${docs}">
        <tr>
            ...
            <td>
                ...
                <a href="${pageContext.request.contextPath}/document/delete?id=${doc.id}" onclick="return confirm('确定要删除这个档案吗？')" class="action-btn" style="background:#e53935;">删除</a>
            </td>
        </tr>
    </c:forEach>
</table>
